...
# Author: Cosmelon
# Type: single
# @s = @a (-null,1] blocks from a tank kit NPC
...
# kit info
execute if score +rKActive tbCore matches 1 run tellraw @s [{"text":"» ","color":"gray"},{"text":"You selected the tank kit!","color":"gold"}]
...
item replace entity @s hotbar.0 with golden_axe{Unbreakable:1b}
