...
execute if score +keyDropped tbR2_RedR2 matches 1 run tag @e[type=item,nbt={Item:{id:"minecraft:tripwire_hook",Count:1b}},distance=..12] add yellowKey2
...
# holding key
execute as @a[nbt={Inventory:[{id:"minecraft:tripwire_hook",tag:{display:{Name:'[{"text":"Key 2","italic":false,"color":"yellow"}]'}}}]}] run tag @s add keyHolder_yellowR2
execute as @a[tag=keyHolder_yellowR2,nbt={SelectedItem:{id:"minecraft:tripwire_hook",tag:{display:{Name:'[{"text":"Key 2","italic":false,"color":"yellow"}]'}}}}] run tag @s add holdingKey_yellowR2
execute as @a[tag=keyHolder_yellowR2,nbt={SelectedItem:{id:"minecraft:tripwire_hook",tag:{display:{Name:'[{"text":"Key 2","italic":false,"color":"yellow"}]'}}}}] run item replace entity @s weapon.offhand with carrot_on_a_stick{Unbreakable:1b}
execute as @a[tag=keyHolder_yellowR2,nbt=!{SelectedItem:{id:"minecraft:tripwire_hook",tag:{display:{Name:'[{"text":"Key 2","italic":false,"color":"yellow"}]'}}}}] if entity @s[nbt={Inventory:[{Slot:-106b,id:"minecraft:carrot_on_a_stick"}]}] run item replace entity @s weapon.offhand with air
execute as @a[tag=keyHolder_yellowR2,nbt=!{SelectedItem:{id:"minecraft:tripwire_hook",tag:{display:{Name:'[{"text":"Key 2","italic":false,"color":"yellow"}]'}}}}] if entity @s[nbt=!{Inventory:[{Slot:-106b,id:"minecraft:air"}]}] run tag @s remove holdingKey_yellowR2
execute as @a[nbt=!{Inventory:[{id:"minecraft:tripwire_hook",tag:{display:{Name:'[{"text":"Key 2","italic":false,"color":"yellow"}]'}}}]}] run tag @s remove keyHolder_yellowR2
