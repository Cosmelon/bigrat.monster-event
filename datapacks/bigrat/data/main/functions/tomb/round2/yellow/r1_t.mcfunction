...
execute if score +keyDropped tbR2_YellowR1 matches 1 run tag @e[type=item,nbt={Item:{id:"minecraft:nether_wartCount:1b}},distance=..12] add yellowKey1
...
# holding key
execute as @a[nbt={Inventory:[{id:"minecraft:nether_warttag:{display:{Name:'[{"text":"Key 1","italic":false,"color":"yellow"}]'}}}]}] run tag @s add keyHolder_yellowR1
execute as @a[tag=keyHolder_yellowR1,nbt={SelectedItem:{id:"minecraft:nether_warttag:{display:{Name:'[{"text":"Key 1","italic":false,"color":"yellow"}]'}}}}] run tag @s add holdingKey_yellowR1
execute as @a[tag=keyHolder_yellowR1,nbt={SelectedItem:{id:"minecraft:nether_warttag:{display:{Name:'[{"text":"Key 1","italic":false,"color":"yellow"}]'}}}}] run item replace entity @s weapon.offhand with carrot_on_a_stick{Unbreakable:1b}
execute as @a[tag=keyHolder_yellowR1,nbt=!{SelectedItem:{id:"minecraft:nether_warttag:{display:{Name:'[{"text":"Key 1","italic":false,"color":"yellow"}]'}}}}] if entity @s[nbt={Inventory:[{Slot:-106b,id:"minecraft:carrot_on_a_stick"}]}] run item replace entity @s weapon.offhand with air
execute as @a[tag=keyHolder_yellowR1,nbt=!{SelectedItem:{id:"minecraft:nether_warttag:{display:{Name:'[{"text":"Key 1","italic":false,"color":"yellow"}]'}}}}] if entity @s[nbt=!{Inventory:[{Slot:-106b,id:"minecraft:air"}]}] run tag @s remove holdingKey_yellowR1
execute as @a[nbt=!{Inventory:[{id:"minecraft:nether_warttag:{display:{Name:'[{"text":"Key 1","italic":false,"color":"yellow"}]'}}}]}] run tag @s remove keyHolder_yellowR1
