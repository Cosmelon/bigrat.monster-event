...
# your position
execute as @a[tag=player] if score @s raceOMilli matches ..9 if score @s raceOSec matches ..9 run tellraw @s [{"text":"You placed "},{"score":{"name":"@s","objective":"racePos"},"color":"green"},{"text":"/","color":"gold"},{"score":{"name":".players","objective":"br_teamCheck"}},{"text":", completing the course in "},{"score":{"name":"@s","objective":"raceOMin"},"color":"green"},{"text":":0","color":"green"},{"score":{"name":"@s","objective":"raceOSec"},"color":"green"},{"text":".0","color":"green"},{"score":{"name":"@s","objective":"raceOMilli"},"color":"green"}]
execute as @a[tag=player] if score @s raceOMilli matches 10.. if score @s raceOSec matches ..9 run tellraw @s [{"text":"You placed "},{"score":{"name":"@s","objective":"racePos"},"color":"green"},{"text":"/","color":"gold"},{"score":{"name":".players","objective":"br_teamCheck"}},{"text":", completing the course in "},{"score":{"name":"@s","objective":"raceOMin"},"color":"green"},{"text":":0","color":"green"},{"score":{"name":"@s","objective":"raceOSec"},"color":"green"},{"text":".","color":"green"},{"score":{"name":"@s","objective":"raceOMilli"},"color":"green"}]
execute as @a[tag=player] if score @s raceOMilli matches ..9 if score @s raceOSec matches 10.. run tellraw @s [{"text":"You placed "},{"score":{"name":"@s","objective":"racePos"},"color":"green"},{"text":"/","color":"gold"},{"score":{"name":".players","objective":"br_teamCheck"}},{"text":", completing the course in "},{"score":{"name":"@s","objective":"raceOMin"},"color":"green"},{"text":":","color":"green"},{"score":{"name":"@s","objective":"raceOSec"},"color":"green"},{"text":".0","color":"green"},{"score":{"name":"@s","objective":"raceOMilli"},"color":"green"}]
execute as @a[tag=player] if score @s raceOMilli matches 10.. if score @s raceOSec matches 10.. run tellraw @s [{"text":"You placed "},{"score":{"name":"@s","objective":"racePos"},"color":"green"},{"text":"/","color":"gold"},{"score":{"name":".players","objective":"br_teamCheck"}},{"text":", completing the course in "},{"score":{"name":"@s","objective":"raceOMin"},"color":"green"},{"text":":","color":"green"},{"score":{"name":"@s","objective":"raceOSec"},"color":"green"},{"text":".","color":"green"},{"score":{"name":"@s","objective":"raceOMilli"},"color":"green"}]
