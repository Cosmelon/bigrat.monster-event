...
# clear signs
data modify block 1003 26 -6041 front_text.messages[0] set value '[{"text":"Red: ","color":"red"},{"score":{"name":".red","objective":"teamScores"},"color":"gold"}]'
data modify block 1002 26 -6041 front_text.messages[0] set value '[{"text":"Blue: ","color":"blue"},{"score":{"name":".blue","objective":"teamScores"},"color":"gold"}]'
data modify block 1001 26 -6041 front_text.messages[0] set value '[{"text":"Green: ","color":"green"},{"score":{"name":".green","objective":"teamScores"},"color":"gold"}]'
data modify block 1000 26 -6041 front_text.messages[0] set value '[{"text":"Yellow: ","color":"yellow"},{"score":{"name":".yellow","objective":"teamScores"},"color":"gold"}]'
