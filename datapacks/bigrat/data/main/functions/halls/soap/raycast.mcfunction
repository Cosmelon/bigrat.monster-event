...
execute as @e[tag=!raycasting,type=!#main:not_mob,dx=0] positioned ~-0.99 ~-0.99 ~-0.99 if entity @s[dx=0] positioned ~0.99 ~0.99 ~0.99 run function main:halls/soap/collide
