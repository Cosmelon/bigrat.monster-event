...
execute if score .yellow teamScores > .green teamScores if score .green teamScores > .red teamScores if score .red teamScores > .blue teamScores run scoreboard players set .greenPos teamScores 1
execute if score .yellow teamScores > .green teamScores if score .green teamScores > .red teamScores if score .red teamScores > .blue teamScores run scoreboard players set .redPos teamScores 1
execute if score .yellow teamScores > .green teamScores if score .green teamScores > .red teamScores if score .red teamScores > .blue teamScores run scoreboard players set .bluePos teamScores 1
...
execute if score .yellow teamScores > .green teamScores if score .green teamScores > .blue teamScores if score .blue teamScores > .red teamScores run scoreboard players set .greenPos teamScores 1
execute if score .yellow teamScores > .green teamScores if score .green teamScores > .blue teamScores if score .blue teamScores > .red teamScores run scoreboard players set .bluePos teamScores 1
execute if score .yellow teamScores > .green teamScores if score .green teamScores > .blue teamScores if score .blue teamScores > .red teamScores run scoreboard players set .redPos teamScores 1
...
execute if score .yellow teamScores > .blue teamScores if score .blue teamScores > .red teamScores if score .red teamScores > .green teamScores run scoreboard players set .bluePos teamScores 1
execute if score .yellow teamScores > .blue teamScores if score .blue teamScores > .red teamScores if score .red teamScores > .green teamScores run scoreboard players set .redPos teamScores 1
execute if score .yellow teamScores > .blue teamScores if score .blue teamScores > .red teamScores if score .red teamScores > .green teamScores run scoreboard players set .greenPos teamScores 1
...
execute if score .yellow teamScores > .blue teamScores if score .blue teamScores > .green teamScores if score .green teamScores > .red teamScorees run scoreboard players set .bluePos teamScores 1
execute if score .yellow teamScores > .blue teamScores if score .blue teamScores > .green teamScores if score .green teamScores > .red teamScorees run scoreboard players set .greenPos teamScores 1
execute if score .yellow teamScores > .blue teamScores if score .blue teamScores > .green teamScores if score .green teamScores > .red teamScorees run scoreboard players set .redPos teamScores 1
