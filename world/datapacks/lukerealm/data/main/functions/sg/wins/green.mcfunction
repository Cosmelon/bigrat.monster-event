...
execute if score ~aliveRed sg matches 0 if score !aliveBlue sg matches 0 if score ~aliveGreen 1.. matches 0 if score ~aliveYellow sg matches 0 run function main:sg/killsg