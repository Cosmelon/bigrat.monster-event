...
execute if score ~red sgPlayers matches 0 if score ~blue sgPlayers matches 1.. if score ~green sgPlayers matches 0 if score ~yellow sgPlayers matches 1.. run function main:sg/killsg