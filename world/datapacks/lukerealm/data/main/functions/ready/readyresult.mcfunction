...
execute if score .ready teamCheck < .players teamCheck run tellraw @a [{"selector":"@a[tag=player,tag=!readyCheck]"},{"text":" isn't ready! Make fun of 'em!","color":"gold"}]
...
scoreboard objectives remove readyCheckYes
scoreboard objectives remove readyCheckNo
