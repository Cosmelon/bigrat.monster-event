...
execute if score ?red blockParty matches 1.. if score ?blue blockParty matches 0 if score ?green blockParty matches 1.. if score ?yellow blockParty matches 0 run function main:blockparty/killbp