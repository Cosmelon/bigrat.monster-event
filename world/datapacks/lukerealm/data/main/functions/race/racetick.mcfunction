...
execute if score !raceTime raceSec matches 0..9 run execute if score !raceTime raceMilli matches 0..9 run bossbar set minecraft:racetime name [{"text":"Game Time: ","color":"gold"},{"score":{"name": "!raceTime","objective":"raceMin"},"color":"green"},{"text":":0","color":"green"},{"score":{"name":"!raceTime","objective":"raceSec"},"color":"green"},{"text":".0","color":"green"},{"score":{"name":"!raceTime","objective":"raceMilli"},"color":"green"}]
execute if score !raceTime raceSec matches 10.. run execute if score !raceTime raceMilli matches 0..9 run bossbar set minecraft:racetime name [{"text":"Game Time: ","color":"gold"},{"score":{"name": "!raceTime","objective":"raceMin"},"color":"green"},{"text":":","color":"green"},{"score":{"name":"!raceTime","objective":"raceSec"},"color":"green"},{"text":".0","color":"green"},{"score":{"name":"!raceTime","objective":"raceMilli"},"color":"green"}]
execute if score !raceTime raceSec matches 0..9 run execute if score !raceTime raceMilli matches 10.. run bossbar set minecraft:racetime name [{"text":"Game Time: ","color":"gold"},{"score":{"name": "!raceTime","objective":"raceMin"},"color":"green"},{"text":":0","color":"green"},{"score":{"name":"!raceTime","objective":"raceSec"},"color":"green"},{"text":".","color":"green"},{"score":{"name":"!raceTime","objective":"raceMilli"},"color":"green"}]
execute if score !raceTime raceSec matches 10.. run execute if score !raceTime raceMilli matches 10.. run bossbar set minecraft:racetime name [{"text":"Game Time: ","color":"gold"},{"score":{"name": "!raceTime","objective":"raceMin"},"color":"green"},{"text":":","color":"green"},{"score":{"name":"!raceTime","objective":"raceSec"},"color":"green"},{"text":".","color":"green"},{"score":{"name":"!raceTime","objective":"raceMilli"},"color":"green"}]
...
execute as @a[gamemode=adventure,scores={raceMilli=..9,raceSec=10..,raceMin=0}] run title @s actionbar [{"text":"Lap: ","color":"gold"},{"color":"green","score":{"name":"@s","objective":"raceLap"}},{"text":"/3   ","color":"green"},{"text":"Time: ","color":"gold"},{"score":{"name": "@s","objective":"raceMin"},"color":"green"},{"text":":0","color":"green"},{"score":{"name":"@s","objective":"raceSec"},"color":"green"},{"text":".0","color":"green"},{"score":{"name":"@s","objective":"raceMilli"},"color":"green"}]
execute as @a[gamemode=adventure,scores={raceMilli=10..99,raceSec=10..,raceMin=0}] run title @s actionbar [{"text":"Lap: ","color":"gold"},{"color":"green","score":{"name":"@s","objective":"raceLap"}},{"text":"/3   ","color":"green"},{"text":"Time: ","color":"gold"},{"score":{"name": "@s","objective":"raceMin"},"color":"green"},{"text":":0","color":"green"},{"score":{"name":"@s","objective":"raceSec"},"color":"green"},{"text":".","color":"green"},{"score":{"name":"@s","objective":"raceMilli"},"color":"green"}]
# 1-9 min
