...
execute as @a[gamemode=adventure,x=294,dx=1,y=75,dy=10,z=37,dz=10] run execute if score @s raceCP matches 6 run execute if score @s raceLap matches 0 run scoreboard players set @s raceLap 1
execute as @a[gamemode=adventure,x=294,dx=1,y=75,dy=10,z=37,dz=10] run scoreboard players set @s raceCP 0
execute as @a[gamemode=adventure,x=294,dx=1,y=75,dy=10,z=37,dz=10] run execute if score @s raceCP matches 6 run execute if score @s raceLap matches 1 run scoreboard players set @s raceLap 2
execute as @a[gamemode=adventure,x=294,dx=1,y=75,dy=10,z=37,dz=10] run scoreboard players set @s raceCP 0
execute as @a[gamemode=adventure,x=294,dx=1,y=75,dy=10,z=37,dz=10] run execute if score @s raceCP matches 6 run execute if score @s raceLap matches 2 run scoreboard players set @s raceLap 3
execute as @a[gamemode=adventure,x=294,dx=1,y=75,dy=10,z=37,dz=10] run scoreboard players set @s raceCP 0
