...
execute as @a[gamemode=adventure] run execute as @s run execute if block ~ ~-1 ~ light_blue_glazed_terracotta run item replace entity @s armor.chest with elytra
