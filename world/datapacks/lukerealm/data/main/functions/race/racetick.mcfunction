...
# execute as @a[gamemode=adventure] run execute as @s run execute unless block ~ ~-1 ~ light_blue_glazed_terracotta run item replace entity @s armor.chest with elytra
execute as @a[gamemode=adventure] run execute as @s run execute unless block ~ ~-0.25 ~ air run item replace entity @s armor.chest with air
