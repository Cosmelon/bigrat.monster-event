...
tellraw @a [{"selector":"@s"},{"text":" finished lap ","color":"gold"},{"score":{"name":"@s","objective":"raceLap"},"color":"green"},{"text":"/3 in place: ","color":"gold"},{"score":{"name":"@s","objective":"racePos"}}]
