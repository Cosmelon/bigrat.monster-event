...
# super snowball break sides
execute as @e[type=snowball,name="troll"] at @s if block ^5 ^ ^ snow_block run scoreboard players set @s spleef_sb 1
execute as @e[type=snowball,name="troll"] if score @s spleef_sb matches 1 at @s if block ^5 ^ ^ snow_block run setblock ^5 ^ ^ air destroy
execute as @e[type=snowball,name="troll"] if score @s spleef_sb matches 1 run kill @s
