...
execute if score $red spleefPlayers matches 1.. if score $blue spleefPlayers matches 0 if score $green spleefPlayers matches 0 if score $yellow spleefPlayers matches 0 run function main:spleef/killspleef