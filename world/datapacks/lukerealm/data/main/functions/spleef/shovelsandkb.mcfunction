...
# spleef shovels
give @a[team=Red] minecraft:diamond_shovel{CanDestroy:[snow_block],Unbreakable:1b,Enchantments:[{id:"efficiency",lvl:255s}]}
give @a[team=Blue] minecraft:diamond_shovel{CanDestroy:[snow_block],Unbreakable:1b,Enchantments:[{id:"efficiency",lvl:255s}]}
give @a[team=Green] minecraft:diamond_shovel{CanDestroy:[snow_block],Unbreakable:1b,Enchantments:[{id:"efficiency",lvl:255s}]}
give @a[team=Yellow] minecraft:diamond_shovel{CanDestroy:[snow_block],Unbreakable:1b,Enchantments:[{id:"efficiency",lvl:255s}]}
