...
tellraw @s {"text":"Backrooms","color":"#9051DF","clickEvent":{"action":"run_command","value":"/tp @s -1000 50 1000"}}
tellraw @s {"text":"Block Party","color":"#FFC0CB","clickEvent":{"action":"run_command","value":"/tp @s -2000.5 100 3000.5"}}
tellraw @s {"text":"PVE","color":"#FFC0CB","clickEvent":{"action":"run_command","value":"/tp @s 5006.48 4.00 -63.59 1488.84 2.63"}}
