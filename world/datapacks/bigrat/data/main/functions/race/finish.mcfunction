...
#tellraw @a [{"text":"1st","color":"#e8ce5e"},{"text":" - ","color":"white"},{"selector":"@a[scores={racePos=1}]"},{"score":{"name":"@a[scores={racePos=1},limit=1]","objective":"raceOMin"}}]
#tellraw @a [{"text":"2nd","color":"#cccccc"},{"text":" - ","color":"white"},{"selector":"@a[scores={racePos=2}]"},{"score":{"name":"@a[scores={racePos=2},limit=1]","objective":"raceOMin"}}]
#tellraw @a [{"text":"3rd","color":"#a05d37"},{"text":" - ","color":"white"},{"selector":"@a[scores={racePos=3}]"},{"score":{"name":"@a[scores={racePos=3},limit=1]","objective":"raceOMin"}}]
#tellraw @a [{"text":"4th","color":"#FFFFFF"},{"text":" - ","color":"white"},{"selector":"@a[scores={racePos=4}]"},{"score":{"name":"@a[scores={racePos=4},limit=1]","objective":"raceOMin"}}]
#tellraw @a [{"text":"5th","color":"#FFFFFF"},{"text":" - ","color":"white"},{"selector":"@a[scores={racePos=5}]"},{"score":{"name":"@a[scores={racePos=5},limit=1]","objective":"raceOMin"}}]
