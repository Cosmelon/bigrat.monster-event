...
#summon minecraft:item ~ ~ ~ {Item:{id:"tripwire_hook",Count:1,tag:{display:{Name:'[{"text":"Key 3","italic":false,"color":"yellow"}]'}}},CustomName:'[{"text":"yellow key"}]',CustomNameVisible:1b}
