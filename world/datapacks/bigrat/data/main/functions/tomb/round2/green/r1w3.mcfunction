# Description: green team room1 wave3
# Author: Cosmelon
# Type: wave start
...
tellraw @a[tag=admin] {"text":"[Debug] Round2 Room1 Wave3 has started for GREEN TEAM","color":"gray"}
...
summon zombie ~-3 ~ ~3 {CustomName:'{"text":"are you me?"}',PersistenceRequired:1b,DeathLootTable:"main:entity_empty"}
summon zombie ~ ~ ~-2 {CustomName:'{"text":"Nice."}',PersistenceRequired:1b,DeathLootTable:"main:entity_empty"}
tag @e[type=zombie,distance=..12] add tbR2_r1w3Green

# set variables
scoreboard players set +wave tbR2_GreenR1 3