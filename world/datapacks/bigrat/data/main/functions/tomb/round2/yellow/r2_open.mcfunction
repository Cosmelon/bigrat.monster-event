...
# remove key
clear @a[team=Yellow] tripwire_hook{display:{Name:'[{"text":"Key 1","italic":false,"color":"yellow"}]'}}
...
# respawn dead
gamemode spectator @a[scores={tbR2_Deaths=1..},team=Yellow]
tp @a[scores={tbR2_Deaths=1..},team=Yellow] 5059.5 40 161.5