...
# remove key
clear @a[team=Blue] tripwire_hook{display:{Name:'[{"text":"Key 2","italic":false,"color":"blue"}]'}}
...
# respawn dead
gamemode spectator @a[scores={tbR2_Deaths=1..},team=Blue]
tp @a[scores={tbR2_Deaths=1..},team=Blue] 5095.5 40 55.5