...
execute positioned 5144.5 37 2.5 store result score +redR3 tbR2_PC if entity @a[team=Red,distance=..23]
...
execute if score +redR3 tbR2_PC = .red teamCheck if score +wave tbR2_RedR3 matches 0 run function main:tomb/round2/red/r3_s
