# Description: blue team room1 wave1
# Author: Cosmelon
# Type: wave start
# run from main:tomb/round2/blue/r1_s
...
tellraw @a[tag=admin] {"text":"[Debug] Round2 Room1 Wave1 has started for BLUE TEAM","color":"gray"}
...
tag @e[type=zombie,distance=..12] add tbR2_r1w1Blue